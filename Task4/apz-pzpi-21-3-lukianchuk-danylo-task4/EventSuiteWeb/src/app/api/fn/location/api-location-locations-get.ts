...
export function apiLocationLocationsGet(http: HttpClient, rootUrl: string, params?: ApiLocationLocationsGet$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
